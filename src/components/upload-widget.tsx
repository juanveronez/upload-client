  ...
  return (
    <Collapsible.Root onOpenChange={() => toggleWidgetOpen()} asChild>
      <motion.div
        ...
        className={`
          bg-zinc-900 w-full overflow-hidden rounded-xl data-[state=open]:shadow-shape border border-transparent animate-border
      ...
      >
        ...
        <Collapsible.Content asChild>
          <div className="flex flex-col h-full">
            ...
            <div className="flex flex-col gap-4 py-3 h-full overflow-hidden">
